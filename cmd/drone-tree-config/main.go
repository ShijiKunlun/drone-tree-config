...
type (
	spec struct {
		...
		GiteaServer         string        `envconfig:"GITEA_SERVER" default:"https://gitea.com"`
...
func main() {
	...
	if spec.GiteaToken == "" && spec.GitHubToken == "" && spec.GitLabToken == "" && (spec.BitBucketClient == "" || spec.BitBucketSecret == "") {
